...
@interface NSNumber (SWIFT_EXTENSION(FunPlusSDK))
@end
...
*/
SWIFT_CLASS("_TtC10FunPlusSDK15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(FunPlusSDK)) <NSURLSessionStreamDelegate>
/**
...
@interface SessionDelegate (SWIFT_EXTENSION(FunPlusSDK)) <NSURLSessionTaskDelegate>
/**
...
*/
SWIFT_CLASS("_TtC10FunPlusSDK12TaskDelegate")
...
@interface NSURLSession (SWIFT_EXTENSION(FunPlusSDK))
@end
